...
• All-Terrain Tread: Our proprietary horseshoe tread pattern grips from heel brake to toe roll.</div>
              <div class="tab-pane fade" id="product-rating" role="tabpanel" aria-labelledby="product-rating-tab">Good: Keen shoes are a great brand and need no further commenting. Not so good: customer service needs to be seriously looked at, which is why I’ve taken off one star.</div>
            </div>
          </div>
        </div>
        <!-- /.card-body -->
